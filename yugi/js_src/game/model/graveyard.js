...
goog.provide('yugi.game.model.Graveyard');
 ...
 */
yugi.game.model.Graveyard = function(isOpponent) {
  goog.base(this);
   ...
   * @protected
   */
  this.logger = goog.debug.Logger.getLogger('yugi.game.model.Graveyard');
...
goog.inherits(yugi.game.model.Graveyard, yugi.model.CardList);


/** @override */
yugi.game.model.Graveyard.prototype.add = function(card, opt_front) {
